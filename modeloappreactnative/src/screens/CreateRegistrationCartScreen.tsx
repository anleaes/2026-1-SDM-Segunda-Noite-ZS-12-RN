...
type Props = DrawerScreenProps<DrawerParamList, "CreateRegistrationCart">;
...
const CreateRegistrationCartScreen = ({ navigation }: Props) => {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Novo Carrinho de Matrícula</Text>
...
export default CreateRegistrationCartScreen;