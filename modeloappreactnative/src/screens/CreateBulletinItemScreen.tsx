...
type Props = DrawerScreenProps<DrawerParamList, "CreateBulletinItem">;
...
const CreateBulletinItemScreen = ({ navigation }: Props) => {
  ...
  const handleSave = async () => {
    ...
    try {
      await fetch("http://localhost:8000/bulletinitem/", {
        method: "POST",
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Novo Item de Boletim</Text>
...
export default CreateBulletinItemScreen;